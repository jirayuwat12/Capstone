...
class RDN_residual_interp_2_input(nn.Module):
    def __init__(self, G0=64, D=6, C=4, G=32):
        ...
        for i in range(self.D):
            self.RDBs.append(RDB(growRate0=self.G0, growRate=self.G, nConvLayers=self.C))
    ...
    def forward(self, B1, B3, B5, B7, B9, previous_input=None):
        if self.lstm == True:
            ...
            if previous_input[0] is not None:
                ...
                self.I5_prime_prime = self.model4_1(
                    p6_prime_prime_prime, self.I4_prime, self.I4_prime_prime, self.I6_prime_prime, self.I6_prime
                )
            else:
...
class RDN_residual_interp_5_input_ConvLSTM_L(nn.Module):
    ...
    def forward(self, B1, B3, B5, B7, B9, B11):
        ...
        for i in [input1, input2]:
            B1, B3, B5, B7, B9 = i
            previous_inputs = [
                hidden_state_4_prime,
                hidden_state_6_prime,
                hidden_state_8_prime,
                hidden_state_5_prime_prime,
                hidden_state_7_prime_prime,
                hidden_state_6_prime_prime_prime,
            ]
