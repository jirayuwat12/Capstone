...
class BINDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"LQs": img_LQs, "GTenh": img_GTenh, "GTinp": img_GTinp, "key": key}
    ...
    def Adobe_BIN_loader(im_path_pair, input_frame_size=(3, 128, 256), data_aug=True, transform=None):
        ...
        B1 = B1[
            h_offset : h_offset + input_frame_size[1], w_offset : w_offset + input_frame_size[2], :
        ]  # imresize(im_pre, (128, 424))[:, 20:404, :]
        B3 = B3[
            h_offset : h_offset + input_frame_size[1], w_offset : w_offset + input_frame_size[2], :
        ]  # imresize(im_pre, (128, 424))[:, 20:404, :]
        B5 = B5[
        ...
        return [B1, B3, B5, B7, B9, B11], [I1, I3, I5, I7, I9, I11], [I2, I4, I6, I8, I10], key
    ...
    def _make_dataset_deep_long_(dir, sharp_index, split=100, mode="train"):
        ...
        return (
            (framesPath[:split_index], framesPath[split_index:]) if split_index < len(framesPath) else (framesPath, [])
        )
