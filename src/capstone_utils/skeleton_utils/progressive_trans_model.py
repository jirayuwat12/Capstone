...
SKELETON_HAND_MODEL = (
    ...
    (0, 5, 0), (5, 6, 1), (6, 7, 2), (7, 8, 3),
    (5, 9, 0), (9, 10, 1), (10, 11, 2), (11, 12, 3),
    (0, 17, 0), (17, 18, 1), (18, 19, 2), (19, 20, 3),
    (17, 13, 0), (13, 14, 1), (14, 15, 2), (15, 16, 3)
)
HAND_JOINT_TO_PREV_JOINT_INDEX = dict((bone[1], bone[0]) for bone in SKELETON_HAND_MODEL)

HAND_JOINT_TO_CHILD_JOINTS_INDEX = {}
for bone in SKELETON_HAND_MODEL:
    if bone[0] not in HAND_JOINT_TO_CHILD_JOINTS_INDEX:
        HAND_JOINT_TO_CHILD_JOINTS_INDEX[bone[0]] = []
    HAND_JOINT_TO_CHILD_JOINTS_INDEX[bone[0]].append(bone[1])
