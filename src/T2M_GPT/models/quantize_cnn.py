...
class QuantizeEMAReset(nn.Module):
    ...
    def reset_codebook(self):
        ...
        self.register_buffer("codebook", torch.zeros(self.nb_code, self.code_dim, device=self.device))
    ...
    def _tile(self, x):
        ...
        if nb_code_x < self.nb_code:
            ...
            out = out + torch.randn_like(out, device=out.device) * std
        else:
            out = x
        return out
    ...
    def init_codebook(self, x):
        ...
        self.code_count = torch.ones(self.nb_code, device=x.device)
        self.init = True
