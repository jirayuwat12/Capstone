...
dataset_opt_path = (
    "checkpoints/kit/Comp_v6_KLD005/opt.txt" if args.dataname == "kit" else "checkpoints/t2m/Comp_v6_KLD005/opt.txt"
)
...
train_loader = dataset_TM_train.DATALoader(
    args.dataname, args.batch_size, args.nb_code, args.vq_name, unit_length=2**args.down_t
)
