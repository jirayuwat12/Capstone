...
def get_args_parser():
    parser = argparse.ArgumentParser(
        description="Optimal Transport AutoEncoder training for Amass",
        add_help=True,
    ...
    parser.add_argument(
        "--lr-scheduler", default=[60000], nargs="+", type=int, help="learning rate schedule (iterations)"
    )
    parser.add_argument("--gamma", default=0.05, type=float, help="learning rate decay")

    parser.add_argument("--weight-decay", default=1e-6, type=float, help="weight decay")
    parser.add_argument(
        "--decay-option", default="all", type=str, choices=["all", "noVQ"], help="disable weight decay on codebook"
    )
    parser.add_argument(
        "--optimizer", default="adamw", type=str, choices=["adam", "adamw"], help="disable weight decay on codebook"
    )
    ...
    parser.add_argument(
        "--vq-act", type=str, default="relu", choices=["relu", "silu", "gelu"], help="dataset directory"
    )
    ...
    parser.add_argument(
        "--exp-name", type=str, default="exp_debug", help="name of the experiment, will create a file inside out-dir"
    )
    parser.add_argument(
        "--vq-name",
        type=str,
